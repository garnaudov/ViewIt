...
1. Потребителят трябва да има инсталиран Xampp на своята машина след, което трябва да стартира Apache и MySQL.(може да изтеглите Xampp от тук: https://www.apachefriends.org/download.html)
